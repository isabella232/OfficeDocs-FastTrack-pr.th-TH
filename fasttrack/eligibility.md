...
FastTrackของคุณพร้อมให้บริการลูกค้าที่มีสิทธิ์การใช้งาน 150 สิทธิ์หรือมากกว่าจากหนึ่งในแผนที่มีสิทธิ์จากครอบครัวผลิตภัณฑ์ Microsoft ต่อไปนี้: Microsoft 365, Office 365, Enterprise Mobility & Security และ Windows 10 แผนเหล่านี้สามารถเป็นผลิตภัณฑ์แต่ละรายการ (เช่น Exchange Online) หรือชุดผลิตภัณฑ์ (Office 365 E3) เนื่องจาก Microsoft มีตัวเลือกการซื้อมากมาย รายการของแผนที่มีสิทธิ์จะครอบคลุมและพบใน[แผนที่มีสิทธิ์](#eligible-plans)
...
คุณต้องซื้อสิทธิ์การใช้งานอย่างน้อย 150 สิทธิ์ต่อผู้เช่าจากแผนใดแผนหนึ่งด้านล่างนี้เพื่อให้มีสิทธิ์FastTrack รายการจะถูกจัดกลุ่มตามครอบครัวผลิตภัณฑ์เพื่อช่วยอวยความสะดวกในการค้นหาแผนเฉพาะที่บริษัทของคุณซื้อ: Microsoft 365, Office 365, Enterprise Mobility & Security, Windows 10 
...
\*พร้อมใช้งานเฉพาะFastTrackและฟีเจอร์บนระบบคลาวด์ที่มีสิทธิ์ตามที่อธิบายไว้ในรายละเอียดสิทธิประโยชน์นี้เท่านั้น  
...
> [!NOTE]
> ไม่มีความต้องการด้านสิทธิ์การใช้งานขั้นต่Windows 10ผู้ขายซอฟต์แวร์ (ISVs) ในเชิงพาณิชย์ การร้องขอแอปทั้งหมดต้องWindows 10เวอร์ชันMicrosoft 365 Appsเวอร์ชันปัจจุบันภายในหน้าต่างการบริการหลัก

> [!NOTE]
> สิทธิ์ของFastTrackสิทธิประโยชน์ของศูนย์การจัดการจะยึดตามการซื้อสิทธิ์การใช้งานแบบชําระเงินของแผนต่างๆ ที่กล่าวถึงก่อนหน้านี้ มีข้อยกเว้น FastTrackช่วยเหลือการออนบอร์ด Office 365 E1สิทธิการใช้งานเวอร์ชันทดลองใช้ตั้งแต่ 6 สิงหาคมถึง 30 กันยายน 2021 ให้กับลูกค้าที่มีสิทธิ์ในอินโดนีเซียเพื่อช่วยตอบโต้กับไฟลของ COVID-19 ในปัจจุบัน 
...
|**แผน No-cost (เช่น Office 365 A1แผนสิทธิประโยชน์ของนักเรียน)**   |         |
