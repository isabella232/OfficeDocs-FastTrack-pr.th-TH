...
description: Office 365การออนบอร์ดOffice 365ภาครัฐของสหรัฐอเมริกามีสี่ขั้นตอนหลัก เช่น เริ่มต้น ประเมิน แก้ไข และเปิดใช้งาน คุณสามารถปฏิบัติตามขั้นตอนเหล่านี้ด้วยขั้นการโยกย้ายข้อมูลเพิ่มเติมตามที่แสดงในรูปต่อไปนี้
...
ในระหว่างขั้นตอนนี้ ตัวจัดการ FastTrack จะร่วมกับคุณเกี่ยวกับการวางแผนความสเร็จ ซึ่งแนะนําให้คุณไปยังแหล่งข้อมูลที่เหมาะสมและหลักปฏิบัติที่ดีที่สุดเพื่อให้แนวทางสําหรับคุณในการจัดเตรียมบริการให้พร้อมใช้งานสําหรับองค์กรของคุณ และผลักดันการใช้งานบริการต่างๆ
...
- การตั้งค่าฟีเจอร์ Exchange Online Threat Protection (ATP) ขั้นสูง ถ้าเป็นส่วนหนึ่งของบริการการสมัครใช้งานของคุณเมื่อระเบียน MX ของคุณOffice 365การสมัครใช้งาน ฟีเจอร์นี้กําหนดค่าเป็นส่วนหนึ่งของการตั้งค่าExchange Online Protectionมัลแวร์   
...
สําหรับSharePointออนไลน์OneDrive for Businessเรามีแนวทางระยะไกลสําหรับ: 
- การตั้งค่า DNS   
- การกําหนดค่าพอร์ตไฟร์วอลล์   
- การเตรียมใช้งานผู้ใช้และสิทธิ์การใช้งาน   
- การกําหนดSharePointแบบไฮบริด เช่น การค้นหาแบบไฮบริด ไซต์แบบไฮบริด Taxonomy แบบไฮบริด ชนิดเนื้อหา การสร้างไซต์ด้วยตนเองแบบไฮบริด (SharePoint Server 2013 เท่านั้น) ตัวเปิดใช้แอปแบบขยาย OneDrive for Business แบบไฮบริด และไซต์เอกซ์ทราเน็ต
...
![SharePointและSkype for Businessการออนบอร์ด](media/O365-Onboarding-Enable-SP.png)
...
สําหรับMicrosoft Teamsระยะไกล เรามีแนวทางระยะไกลสําหรับ: 
...
- การประเมินเครือข่ายTeams:
    ...
    - การTeamsนโยบายTeamsแอป (Teamsแอปบนเดสก์ท็อป Teams แอปบนเดสก์ท็อป และ Teams แอป iOS และ Android)
 
<br> หากมี เราจะให้แนวทางสําหรับ: </br>
- Microsoft Teams อุปกรณ์ห้อง:
    - การสร้างบัญชีออนไลน์ที่ต้องใช้ในอุปกรณ์โทรศัพท์และห้องประชุมที่ได้รับการสนับสนุนซึ่งแสดงรายการ<a href="https://go.microsoft.com/fwlink/?linkid=2066478">Teamsในแค็ตตาล็อกอุปกรณ์</a>ต่างๆ
...
- แนวทางสําหรับSkype for Business Teamsการเปลี่ยน 
    
![FastTrack Microsoft Teamsไดอะแกรม (เปิดใช้งานระยะ)](media/42a2d990-4e27-4758-b0cd-0024963c1542.png)
...
สําหรับMicrosoft 365 Appsเราจะให้แนวทางระยะไกลสําหรับ: 
