...
description: Office 365การออนบอร์ดOffice 365ภาครัฐของสหรัฐอเมริกามีสี่ขั้นตอนหลัก คือ เริ่มต้น ประเมิน แก้ไข และเปิดใช้งาน คุณสามารถปฏิบัติตามขั้นตอนเหล่านี้ด้วยขั้นการโยกย้ายข้อมูลเพิ่มเติมตามที่แสดงในรูปต่อไปนี้
...
Office 365ออนบอร์ดมีสี่ขั้นตอนหลัก คือ เริ่มต้น ประเมิน แก้ไข และเปิดใช้งาน คุณสามารถปฏิบัติตามขั้นตอนเหล่านี้ด้วยขั้นการโยกย้ายข้อมูลเพิ่มเติมตามที่แสดงในรูปต่อไปนี้
...
ในระหว่างขั้นตอนนี้ ตัวจัดการ FastTrack ของคุณจะร่วมกับคุณเกี่ยวกับการวางแผนความสเร็จ ซึ่งแนะนําให้คุณไปยังแหล่งข้อมูลที่เหมาะสมและหลักปฏิบัติที่ดีที่สุดเพื่อเป็นแนวทางให้คุณเพื่อให้บริการพร้อมใช้งานสําหรับองค์กรของคุณ และผลักดันการใช้งานบริการต่างๆ
...
![ขั้นตอนการออนบอร์ดหลักระหว่างphase_1การเปิดใช้งาน](media/O365-Onboarding-Enable-Core.png)
...
- การตั้งค่าฟีเจอร์ Exchange Online Threat Protection (ATP) ขั้นสูง ถ้าเป็นส่วนหนึ่งของบริการการสมัครใช้งานของคุณเมื่อระเบียน MX Office 365การเปลี่ยนแปลง ฟีเจอร์นี้กําหนดค่าเป็นส่วนหนึ่งของการตั้งค่าExchange Online Protectionมัลแวร์   
...
สําหรับSharePointออนไลน์และOneDrive for Business เรามีแนวทางระยะไกลสําหรับ: 
- การตั้งค่า DNS   
- การกําหนดค่าพอร์ตไฟร์วอลล์   
...
![SharePointและSkype for Businessการออนบอร์ดของคุณ](media/O365-Onboarding-Enable-SP.png)
