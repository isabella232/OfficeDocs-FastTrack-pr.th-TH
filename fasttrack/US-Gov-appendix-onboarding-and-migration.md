...
ในระหว่างขั้นตอนนี้ ตัวจัดการ FastTrack จะร่วมกับคุณเกี่ยวกับการวางแผนความสเร็จ ซึ่งแนะนําให้คุณไปยังแหล่งข้อมูลที่เหมาะสมและหลักปฏิบัติที่ดีที่สุดเพื่อเป็นแนวทางให้คุณเพื่อให้บริการพร้อมใช้งานสําหรับองค์กรของคุณ และผลักดันการใช้งานบริการต่างๆ
...
- การตั้งค่าฟีเจอร์Exchange Online Advanced Threat Protection (ATP) ถ้าเป็นส่วนหนึ่งของบริการการสมัครใช้งานของคุณเมื่อระเบียน MX Office 365บริการ ฟีเจอร์นี้กําหนดค่าเป็นส่วนหนึ่งของการตั้งค่าExchange Online Protectionมัลแวร์   
...
สําหรับSharePointออนไลน์และOneDrive for Businessเรามีแนวทางระยะไกลสําหรับ: 
- การตั้งค่า DNS   
- การกําหนดค่าพอร์ตไฟร์วอลล์   
...
FastTrack ผู้เชี่ยวชาญด้านจะมอบแนวทางในการโยกย้ายOffice 365ข้อมูลโดยใช้เครื่องมือและเอกสารร่วมกัน และโดยการกําหนดค่างานที่สามารถนําไปใช้ได้และเป็นไปได้
...
- การเปิดใช้งานแผนการโทร แผนการการประชุม Skypeการออกอากาศและการระบบโทรศัพท์แผนบริการและการโทรแบบเฉพาะทาง (ในตลาดที่มีให้ใช้งาน GCCแผน High หรือ DoD) 
...
- ยืนยันความต้องการขั้นต่Exchange Onlineใน Exchange Online, SharePoint Online, Office 365 Groups และ Azure Active Directory (Azure AD) เพื่อสนับสนุนTeamsธุรกิจ
- การกําหนดค่าพอร์ตไฟร์วอลล์   
- การตั้งค่า DNS  
...
- การประเมินเครือข่ายTeams:
    ...
    - การTeamsนโยบายTeamsแอป (Teamsแอปเวอร์ชัน Teams แอปบนเดสก์ท็อป และ Teams แอป iOS และ Android)
 
<br> หากมี เราจะให้แนวทางสําหรับ: </br>
- Microsoft Teams อุปกรณ์ห้อง:
    - การสร้างบัญชีออนไลน์ที่ต้องใช้ในอุปกรณ์โทรศัพท์และห้องประชุมที่ได้รับการสนับสนุนซึ่งแสดงรายการ<a href="https://go.microsoft.com/fwlink/?linkid=2066478">Teamsในแค็ตตาล็อกอุปกรณ์ต่างๆ</a>
...
สําหรับYammer เราจะให้แนวทางระยะไกลสําหรับการเปิดใช้งานYammer Enterpriseบริการของคุณ

> [!NOTE]
> Yammer Enterpriseไม่ใช่คอมโพเนนต์ของ Office 365 US Government แต่สามารถซื้อได้โดยไม่มีค่าใช้จ่ายเป็นข้อเสนอแบบสแตนด์อโลนของแต่ละผู้ใช้ที่ให้สิทธิ์การใช้งานOffice 365ในGCC ข้อเสนอนี้ขณะนี้ถูกจํากัดไว้เฉพาะลูกค้าที่ซื้อOffice 365 GCCภายใต้ข้อตกลงระดับองค์กรและข้อตกลงการสมัครใช้งานขององค์กร Yammerไม่พร้อมใช้งานในแผน GCC High หรือ DoD 
  
## <a name="microsoft-365-apps"></a>Microsoft 365 Apps

สําหรับMicrosoft 365 Appsระยะไกล เรามีแนวทางระยะไกลสําหรับ: 
...
- การติดตั้งMicrosoft 365 Appsออกจากพอร์ทัล Office 365โดยใช้ คลิก-ต่อ-รัน    
...
- การตั้งค่าเซิร์ฟเวอร์การแจกจ่ายภายในMicrosoft 365 AppsเดียวMicrosoft 365 Apps รวมถึงความช่วยเหลือในการสร้างไฟล์configuration.xmlไฟล์เพื่อใช้กับเครื่องมือOffice 365เนื้อหา    
- การปรับใช้Microsoft Endpoint Configuration Manager ผลิตภัณฑ์ รวมถึงความช่วยเหลือในการสร้างMicrosoft Endpoint Configuration Managerบรรจุภัณฑ์
