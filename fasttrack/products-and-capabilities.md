...
<td>  เรามีแนวทางระยะไกลเกี่ยวกับการออนบอร์ดหลัก ซึ่งเกี่ยวข้องกับการเตรียมใช้งานบริการ ผู้เช่า และการผสานรวมข้อมูลเฉพาะตัว นอกจากนี้ยังมีขั้นตอนในการมอบพื้นฐานบริการการออนบอร์ด เช่น Exchange Online, SharePoint Online และ Microsoft Teams รวมทั้งการอภิปรายเกี่ยวกับความปลอดภัย การเชื่อมต่อเครือข่าย<a href="/office365/enterprise/office-365-network-connectivity-principles">และการปฏิบัติตามข้อบังคับ</a>   
...
<li>การเปิดใช้งาน AD FS กับลูกค้าด้วยฟอเรสต์ Active Directory เดี่ยวและข้อมูลเฉพาะตัวที่ซิงโครไนซ์กับเครื่องมือเชื่อมต่อ Azure AD This requires Windows Server 2012 R2 Active Directory Federation Services 2.0 or greater.</li>
...
<li>  หลายฟอเรสต์บัญชี Active Directory และฟอเรสต์ทรัพยากร (Exchange and/or Lync 2010, Lync 2013 หรือ Skype for Business)  </li>
<li>  หลายฟอเรสต์บัญชี Active Directory กับหนึ่งในฟอเรสต์เป็นฟอเรสต์บัญชี Active Directory แบบรวมศูนย์ที่มีExchange และ/หรือ Lync 2010, Lync 2013 หรือ Skype for Business  </li>
...
<li>  การกําหนดสิทธิ์การใช้งานของผู้ใช้ปลายทางและตามอุปกรณ์โดยใช้ศูนย์การจัดการ Microsoft 365 Windows PowerShell  </li>
<li>  การติดตั้งMicrosoft 365 AppsจากOffice 365ของคุณโดยใช้ คลิก-to-รัน  </li>
<li>  การติดตั้งOfficeบนอุปกรณ์เคลื่อนที่ (เช่น Outlook Mobile, Word Mobile, Excel Mobile และ PowerPoint Mobile) บนอุปกรณ์ iOS หรือ Android ของคุณ  </li>
...
<li>  การสร้าง XML การกําหนดOfficeเครื่องมือการปรับใช้ข้อมูลด้วยเครื่องมือการกําหนดOfficeเองหรือ XML ดั้งเดิมเพื่อกําหนดค่าแพคเกจการปรับใช้  </li>
...
<li>  การอนุญาตให้ผู้ใช้สร้างและจัดการความปลอดภัยบนระบบคลาวด์หรือกลุ่มการรักษาความปลอดภัยOffice 365ด้วยการจัดการกลุ่มด้วยตนเองของ Azure AD  </li>
...
<td> <p> Microsoft 365 Defender คือชุดการป้องกันองค์กรแบบก่อนและหลังการรั่วไหลแบบรวมที่รวมเข้าไว้ภายในองค์กร ซึ่งประสานการตรวจหา ป้องกัน ตรวจสอบ และตอบสนองจุดสิ้นสุด ข้อมูลเฉพาะตัว อีเมล และแอปต่างๆ ให้การป้องกันแบบรวมจากการโจมตีที่ซับซ้อน เรามีแนวทางระยะไกลสําหรับ: </p> 
<ul>
...
<td>  Microsoft Cloud App Securityคือนายหน้าด้านความปลอดภัยของ Cloud Access (CASB) ที่ให้การมองเห็นการควบคุมการส่งข้อมูลและการวิเคราะห์ที่ซับซ้อนเพื่อระบุและต่อต้านภัยคุกคามทางไซเบอร์ในบริการระบบคลาวด์ของ Microsoft และบริษัทอื่นทั้งหมด เรามีแนวทางระยะไกลสําหรับ:
<ul>
...
<li> การตรวจทานCloud App Securityและแดชบอร์ดการค้นพบระบบคลาวด์</li>
...
<p><strong>ต่อไปนี้เป็นการไม่อยู่ในขอบเขต</strong></p>
<ul>
<li> Projectการจัดการของกิจกรรมการแก้ไขของลูกค้า</li>
<li> การจัดการอย่างต่อเนื่อง การตอบสนองภัยคุกคาม และการแก้ไข </li>
...
<li> การกําหนดWindowsกิจกรรมจริงของเหตุการณ์</li>
</ul>
<li>  การกําหนดค่าพอร์ทัล รวมถึง </li>
<ul>
<li> การรวม Defender for Identity Microsoft Cloud App Security (ไม่Cloud App Securityให้สิทธิการใช้งานของคุณ) </li>
...
<li> การสนับสนุน<a href=" /fasttrack/us-gov-appendix-overview">GCC-HighหรือGCC-DoD (Office 365ภาครัฐของสหรัฐอเมริกา)</a></li>
<li> การปรับใช้หรือการใช้งาน Defender ต่อไปนี้กับกิจกรรมเซนเซอร์ข้อมูลเฉพาะตัว: </li>
<ul>
...
<tr class="odd">
<td><strong>Microsoft Defender Office 365</strong></td>
<td>  Microsoft Defender Office 365ปกป้ององค์กรของคุณจากภัยคุกคามที่เป็นอันตรายด้วยข้อความอีเมล ลิงก์ (URL) และเครื่องมือการร่วมมือกัน Defender for Office 365ประกอบด้วย:
<ul>
...
<li> <a href="/microsoft-365/security/office-365-security/defender-for-office-365?view=o365-worldwide#view-microsoft-defender-for-office-365-reports">รายงาน</a>: ดูรายงานแบบเรียลไทม์เพื่อตรวจสอบ Defender Office 365ประสิทธิภาพการOffice 365ในองค์กรของคุณ</li>
...
<li> ตัวเชื่อมต่อข้อมูล</li>
<li> การพัฒนาสถาปัตยกรรมข้อมูลSharePointธุรกิจ</li>
...
<li>  การตรวจสอบอีเมลระหว่างการขนส่งโดยใช้กฎExchange Onlineลจดหมายของคุณ  </li>
</ul>
...
<li> การตั้งค่าและการกําหนดค่า ของ Bring Your Own Key (BYOK), Double Key Encryption (DKE) (ไคลเอ็นต์ป้ายผนึกแบบรวมเท่านั้น) หรือ เก็บคีย์ของคุณเอง (HYOK) (เฉพาะไคลเอ็นต์แบบคลาสสิกเท่านั้น) ที่คุณควรต้องการหนึ่งในตัวเลือกเหล่านี้เพื่อการปรับใช้  </li>
  </ul>
</ul>
</td>
</tr>
...
<strong>ปรับใช้Outlookบน iOS และ Android อย่างปลอดภัย</strong> เราสามารถให้แนวทางเพื่อช่วยให้คุณปรับใช้แอปOutlookสําหรับ iOS และ Android อย่างปลอดภัยในองค์กรของคุณเพื่อให้แน่ใจว่าผู้ใช้ของคุณมีแอปที่ต้องใช้ทั้งหมดติดตั้งอยู่  
  ขั้นตอนในการปรับใช้อุปกรณ์เคลื่อนที่Outlook iOS และ Android อย่างปลอดภัยด้วย Intuned ขึ้นอยู่กับสภาพแวดล้อมต้นทางของคุณ ซึ่งสามารถรวมถึง:
<ul>
...
<td>  For Exchange Online, we guide you through the process to get your organization ready to use email. ขั้นตอนที่แน่นอนจะขึ้นอยู่กับสภาพแวดล้อมต้นทางของคุณและแผนการโยกย้ายอีเมลของคุณ  
  เรามีแนวทางระยะไกลสําหรับ:
<ul>
<li>  การตั้งค่าExchange Online Protection (EOP) ทั้งหมดโดเมนที่เปิดใช้งานจดหมายได้รับการตรวจสอบOffice 365อีเมล  </li>
...
<li>  การกําหนดค่าไคลเอ็นต์Outlookกล่องจดหมาย (Windows Outlook บนเว็บกล่องจดหมาย Outlookไคลเอ็นต์กล่องจดหมาย (เช่น for iOS และ Android)  </li>
</ul>
...
<td><strong>การป้องกันข้อมูลของ Microsoft</strong></td>
<td>  
ดูข้อมูลเพิ่มเติมในการรักษาความปลอดภัย<strong>การป้องกันข้อมูลของ Microsoft</strong><a href="/fasttrack/products-and-capabilities#security-and-compliance">ปฏิบัติตามข้อบังคับ</a>
...
<li>  การยืนยันTeamsเปิดใช้งานบนผู้Office 365ของคุณ  </li>
...
<ul>
<li>  การTeamsการตั้งค่านโยบายTeamsแอป (Teams Teamsแอปเวอร์ชันเดสก์ท็อป Teamsแอปของคุณ (แอป iOS และ Android)  </li>
</ul>
หากสามารถนําไปใช้ได้ เรายังให้แนวทางสําหรับ:
<ul>
<li>  Microsoft Teams อุปกรณ์ห้อง:  </li>
<ul>
<li>  การสร้างบัญชีออนไลน์ที่ต้องใช้ในอุปกรณ์โทรศัพท์และห้องประชุมที่ได้รับการสนับสนุนซึ่งแสดงรายการ<a href="https://go.microsoft.com/fwlink/?linkid=2066478">Teamsในแค็ตตาล็อกอุปกรณ์</a>ต่างๆ  </li>
...
<li>  เปิดใช้งานOffice 365กลุ่ม  </li>
  ...
  <strong>หมายเหตุ:</strong> ถ้าไม่มีการมอบหมายและเปิดใช้งานผู้ใช้SharePointสิทธิ์การใช้งาน SharePoint Online พวกเขาจะไม่มีพื้นที่OneDrive for BusinessในOffice 365 การแชร์ไฟล์ยังคงสามารถใช้งานในแชนเนลได้ แต่ผู้ใช้ไม่สามารถแชร์ไฟล์ในการแชทได้โดยไม่OneDrive for Businessเก็บข้อมูลในOffice 365ของคุณ Teamsไม่สนับสนุนSharePointภายในองค์กร  <br>
  ...
  ตัวติดตั้งสMicrosoft Teams Windowsไคลเอ็นต์เดสก์ท็อป Mac และ Mac สามารถดาวน์โหลด <a href="https://go.microsoft.com/fwlink/?linkid=839411">https://go.microsoft.com/fwlink/?linkid=839411</a> ได้จาก  </td>
</tr>

<tr class="even">
<td><strong>Outlookแอป for iOS และ Android</strong></td>
<td>  เรามีแนวทางระยะไกลสําหรับ:
<ul>
...
<td>ซอฟต์แวร์ไคลเอ็นต์ออนไลน์ เช่น Power BI Desktopต้องอยู่ที่ระดับต่สุดตามที่กําหนดไว้ใน ความต้องการของ<a href="https://go.microsoft.com/fwlink/?LinkID=723597">ระบบ</a>Microsoft 365 Office</td>
</tr>
<tr class="even">
<td><strong>Project Online</strong></td>
<td>  เรามีแนวทางระยะไกลสําหรับ:
<ul>
<li>  การตรวจสอบฟังก์ชันSharePointพื้นฐานProject Onlineขึ้นอยู่กับProject Onlineพื้นฐาน  </li>
...
<li>  การกําหนดค่าการตั้งค่าการอัปเดตOffice 365เครื่องมือการปรับใช้ข้อมูล  </li>
<li>  การตั้งค่าเซิร์ฟเวอร์การแจกจ่ายภายในไซต์เดียวProject Onlineไคลเอ็นต์เดสก์ท็อปของคุณ รวมถึงความช่วยเหลือในการสร้างไฟล์ configuration.xml เพื่อใช้กับเครื่องมือOffice 365เนื้อหา  </li>
<li>  การเชื่อมต่อProject Onlineเดสก์ท็อปไคลเอ็นต์กับProject Online ProfessionalหรือProject Online Premium  </li>
</ul></td>
<td>Online client software like Project for Office 365 must be at a minimum level as defined in the <a href="https://go.microsoft.com/fwlink/?LinkID=723597">System requirements for Microsoft 365 and Office</a>.</td>
</tr>
<tr class="even">
...
<li>การSharePointฟีเจอร์ออนไลน์ของคุณ</li>
<li>  การSharePointฟีเจอร์แบบไฮบริด เช่น การค้นหาแบบไฮบริด ไซต์แบบไฮบริด Taxonomy แบบไฮบริด ชนิดเนื้อหา การสร้างไซต์ด้วยตนเองแบบไฮบริด (SharePoint Server 2013 เท่านั้น) ตัวเปิดใช้แอปแบบขยาย ไฮบริด OneDrive for Business และไซต์เอกซ์ทราเน็ต  </li>
...
<li>  การติดตั้ง SharePoint Online 2013 SP1 (ถ้ามี) การวางแผนและการปรับใช้ความต้องการการซิงค์และข้อมูลเฉพาะตัว และการระบุOneDrive for Businessไคลเอ็นต์การซิงค์ของคุณ  </li>
...
<ul>
<li>  SharePoint การกําหนดค่าแบบไฮบริด รวมถึงการกําหนดค่าการค้นหาแบบไฮบริด ไซต์ การจัดโครงสร้าง ชนิดเนื้อหา OneDrive for Business ตัวเปิดใช้แอปเพิ่มเติม ไซต์เอกซ์ทราเน็ต และการสร้างไซต์แบบบริการตนเองที่เชื่อมต่อจากภายในองค์กรไปยังสภาพแวดล้อม SharePoint Online เป้าหมายเดียว  </li>
</ul>
...
<tr class="even">
<td><strong>Azure Active Directory (Azure AD) และ Azure AD Premium</strong></td>
<td>  ดูข้อมูลเพิ่มเติมในการรักษาความปลอดภัย<strong>Azure Active Directory (Azure AD) และ Azure AD</strong> Premium<a href="/fasttrack/products-and-capabilities#security-and-compliance">การรักษาความปลอดภัยและ</a>การปฏิบัติตามข้อบังคับ</td>
<td></td>
</tr>
<tr class="odd">
<td><strong>Azure Information Protection </strong></td>
<td>  ดูข้อมูลเพิ่มเติมเกี่ยวกับ Azure Information Protection โปรดดู<strong>การป้องกันข้อมูลของ Microsoft</strong><a href="/fasttrack/products-and-capabilities#security-and-compliance">การรักษาความปลอดภัยและ</a>การปฏิบัติตามข้อบังคับ  </td>
<td>  
...
<li>  การประเมินสภาพแวดล้อมต้นทางของคุณและข้อMicrosoft Endpoint Configuration Manager (ตรวจสอบให้แน่ใจว่าการอัปเกรดMicrosoft Endpoint Configuration Managerระดับที่ต้องใช้เพื่อสนับสนุนการปรับใช้ Windows 10)  </li>
<li>  การปรับใช้Windows 10 EnterpriseและMicrosoft 365 Appsโดยใช้Microsoft Endpoint Configuration ManagerหรือMicrosoft 365ต่างๆ  </li>
...
<li>  การแปลงระบบWindows 10จาก SINGL เป็นส่วนติดต่อของเฟิร์มแวร์ Extensible (UEFI) ของ UNIFIED  </li>
...
<td><p>เรามีแนวทางการปรับใช้สําหรับการออนบอร์ดWindowsเดสก์ท็อปเสมือน (บริการการเสมือนของเดสก์ท็อปและแอป) Windows เดสก์ท็อปเสมือนจะใช้ประโยชน์จากประสบการณ์Windows 10หลายเซสชันแบบหลายเซสชันและถูกปรับให้เหมาะสมกับ Microsoft 365 Apps for Enterprise ที่มีการรักษาความปลอดภัยและการจัดการที่รวมMicrosoft 365การใช้งาน</p>
<p>เรามีแนวทางระยะไกลสําหรับ:</p>
<ul>
<li>การปรับใช้Windows 10 EnterpriseหลายเซสชันและMicrosoft 365 Apps for Enterprise โดยใช้รายการต่อไปนี้:
<ul>
<li>รูป Azure Marketplace</li>
<li>รูปภาพที่แชร์</li>
<li>Office Deployment Toolkit (ODT)</li>
</ul></li>
<li>การMicrosoft 365 Appsค่าไฟล์ for FSLogix ใน Windowsบนเดสก์ท็อปเสมือน For FSLogix:
<ul>
<li>การปรับใช้ตัวแทน</li>
<li>การกําหนดค่าโปรไฟล์Officeและคอนเทนเนอร์สาธารณะ</li>
...
<li>กฎไฟร์วอลล์เพื่ออนุญาตให้มีการWindowsเดสก์ท็อปเสมือน
</ul>
...
<li>  <strong>Windowsเดสก์ท็อปเสมือน</strong> - For more information, see <a href="/azure/virtual-desktop/overview">What is Windows Virtual Desktop?</a> Windows 10 Enterprise FAQ <a href="/azure/virtual-desktop/windows-10-multisession-faq">multi-session</a>.  </li>
...
<li>บริการบรรจุภัณฑ์ของแอปเท่านั้น แต่แอปแอป Assure ในทีมแพคเกจที่เราได้แก้ไขWindowsเพื่อให้แน่ใจว่าสามารถปรับใช้ในสภาพแวดล้อมของลูกค้าได้</li>
</ul>
...
<ul>
<li> แอปที่Windows 7, Windows 8.1 และ Windows 10ยังสามารถWindowsบน Cloud PC ของ 365</li>
</ul>
...
<ul>
<li>  
  แอปที่เรียกใช้บน Windows 7, Windows 8.1, Windows 10 หรือ Windows Server (แอปเสมือน) จะยังเปิด: </li>
<ul>
<li>  
...
<li>  
  ...
  <strong>หมายเหตุ:</strong> Windowsข้อยกเว้นและข้อจํากัดของความเข้ากันได้ระหว่างเซสชันแบบหลายเซสชันขององค์กร มีดังนี้
<ul>
<li>  
...
<td>
เรามีแนวทางการปรับใช้และการนํามาใช้จากระยะไกล และความช่วยเหลือด้านความเข้ากันได้สําหรับ: <ul> <li>การปรับใช้Microsoft EdgeบนWindows 10กับMicrosoft Endpoint Manager (Microsoft Endpoint Configuration Manager หรือ Intuned)  </li>
