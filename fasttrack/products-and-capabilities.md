...
<li>  การกําหนดSharePointแบบไฮบริด เช่น การค้นหาแบบไฮบริด ไซต์แบบไฮบริด Taxonomy ไฮบริด ชนิดเนื้อหา การสร้างไซต์ด้วยตนเองแบบไฮบริด (SharePoint Server 2013 เท่านั้น) ตัวเปิดใช้แอปแบบขยาย ไฮบริด OneDrive for Business และไซต์เอ็กซ์ทราเน็ต  </li>
<li>  วิธีการโยกย้ายของคุณ  </li>
</ul>
มีแนวทางเพิ่มเติมสําหรับOneDrive for Businessโดยขึ้นอยู่กับSharePointของคุณ เช่น:
<ul>
<li>  ระบุตัวเลือกการรวมและการตรวจสอบโครงสร้างพื้นฐานเครือข่ายออนไลน์และแบนด์วิดท์ภายในองค์กรและแบบออนไลน์  </li>
<li>  การติดตั้ง SharePoint Online 2013 SP1 (ถ้ามี) การวางแผนและการปรับใช้ความต้องการการซิงค์และข้อมูลเฉพาะตัว และการระบุไคลเอ็นต์OneDrive for Businessการซิงค์ของคุณ  </li>
...
<ul>
<li><a href="/azure/virtual-desktop/store-fslogix-profile">ที่เก็บข้อมูลของคอนเทนเนอร์โปรไฟล์ FSLogix Windowsที่โต๊ะเสมือน</a> </li>
</ul>
...
<ul>
<li> แอปที่Windowsบนระบบคลาวด์ 7, Windows 8.1 Windows 10ยังสามารถWindowsบน Cloud PC ได้Windows 365</li>
</ul>
<strong>Windowsวันที่ ARM</strong>
<ul>
<li>  
แอปที่Windows 7, Windows 8.1 และ Windows 10 ยังWindows 10บน Windows 11 บนอุปกรณ์ ARM64 อีกด้วย 
  </li>
</ul>
...
<li>  
  Windows 10 EnterpriseและWindowsแบบหลายเซสชันขององค์กรแบบ 11
  </li>
</ul>
</ul>
