...
<td> <p> Microsoft 365 Defender คือชุดการป้องกันองค์กรแบบก่อนและหลังการรั่วไหลที่รวมเข้าไว้เป็นเอกภาพ ซึ่งประสานการตรวจหา การป้องกัน การตรวจสอบ และการตอบสนองระหว่างจุดสิ้นสุด ข้อมูลเฉพาะตัว อีเมล และแอปต่างๆ ให้การป้องกันแบบรวมจากการโจมตีที่ซับซ้อน เรามีแนวทางระยะไกลสําหรับ: </p> 
<ul>
...
<li> การCloud App Securityและแดชบอร์ดการค้นพบระบบคลาวด์</li>
...
<li>  การเปิดใช้งานบริการจุดสิ้นสุดของ Microsoft Defender โดยอธิบายวิธีการปรับใช้โปรไฟล์ตัวแทนจุดสิ้นสุด การตรวจหาและการตอบสนองปลายทาง (EDR) ของ Defender โดยใช้หนึ่งในวิธีการจัดการที่ได้รับการสนับสนุน  </li>
<li>  แนวทางการปรับใช้ ความช่วยเหลือในการกําหนดค่า และการศึกษาเมื่อ:
<ul>
<li>  
  ภัยคุกคามและการจัดการช่องโหว่คุณ  
  </li>
<li>  
...
<li> การกําหนดWindowsตัวแสดงออกของเหตุการณ์</li>
</ul>
<li>  การกําหนดค่าพอร์ทัล รวมถึง </li>
<ul>
...
<ul>
<li> ไฟร์วอลล์และพร็อกซีของคุณต้องเปิดอยู่เพื่อสื่อสารกับ Defender for Identity Cloud Service (*.atp.azure.com ต้องเปิดพอร์ต 443)</li>
</ul>
...
<ul>
<li>  เครื่องมือOutlookแอป for iOS และ Android, Microsoft Authenticator และIntune Company Portalแอปต่างๆ ด้วย Intuned  </li>
...
<td>  ผู้ดูแลระบบ IT ต้องมีโครงสร้างพื้นฐานผู้ให้บริการออกใบรับรอง เครือข่ายไร้สาย และ VPN ที่ใช้งานได้ในสภาพแวดล้อมการผลิตอยู่แล้ว เมื่อวางแผนการปรับใช้เครือข่ายไร้สายและโปรไฟล์ VPN กับ Intuny  
  ...
  <strong>หมายเหตุ</strong>: สิทธิประโยชน์ของFastTrackการกําหนดค่าไม่มีความช่วยเหลือในการตั้งค่าหรืออัปเกรดเซิร์ฟเวอร์ไซต์ตัวจัดการการกําหนดค่าหรือไคลเอ็นต์ตัวจัดการการกําหนดค่าเป็นความต้องการขั้นต่สุดที่ต้องใช้เพื่อสนับสนุนการแนบ Cloud ติดต่อ <a href="https://go.microsoft.com/fwlink/?linkid=2080150">คู่ค้า Microsoft</a> เพื่อขอรับความช่วยเหลือเกี่ยวกับเรื่องนี้

  <strong>Intuns ที่รวมเข้ากับ Microsoft Defender for Endpoint</strong> 
 
  <strong>หมายเหตุ</strong>: เราให้ความช่วยเหลือในการรวม Intun1 กับ Microsoft Defender for Endpoint และการสร้างนโยบายการปฏิบัติตามนโยบายของอุปกรณ์ตามWindows 10การประเมินระดับความเสี่ยง เราไม่ให้ความช่วยเหลือเกี่ยวกับการซื้อ การให้สิทธิ์การใช้งาน หรือการเปิดใช้งาน ติดต่อ <a href="https://go.microsoft.com/fwlink/?linkid=2080150">คู่ค้า Microsoft</a> เพื่อขอรับความช่วยเหลือเกี่ยวกับเรื่องนี้  
...
<li>  การตั้งค่า Microsoft Defender Office 365คุณลักษณะเฉพาะของคุณหากเป็นส่วนหนึ่งของบริการการสมัครใช้งานของคุณ ดูข้อมูลเพิ่มเติมที่ Microsoft <strong>Defender ในส่วนOffice 365</strong>ของตารางนี้  </li>
...
<ul>
<li>  องค์กรที่ExchangeเดียวหรือหลายExchange Serverปี 2003 เป็นต้นไป  </li>
...
ซอฟต์แวร์ไคลเอ็นต์ออนไลน์ เช่น Project for Office 365, Outlook for Windows, Outlook for iOS และ Android, ไคลเอ็นต์การซิงค์ OneDrive for Business, Power BI Desktop และ Skype for Business ต้องอยู่ที่ระดับต่สุดตามที่กําหนดไว้ใน ความต้องการของระบบMicrosoft 365 Office <a href="https://go.microsoft.com/fwlink/?LinkID=723597"></a>  </td>
</tr>

<td><strong>Microsoft Defender for Office 365</strong></td>
<td>  ดูข้อมูลเพิ่มเติมที่<strong>Microsoft Defender for Office 365</strong>การรักษา<a href="/fasttrack/products-and-capabilities#security-and-compliance">ความปลอดภัยและการปฏิบัติตาม</a>ข้อบังคับ  
</td>
<td></td>
</tr>
...
<td><strong>การป้องกันข้อมูลของ Microsoft</strong></td>
<td>  
ดูข้อมูลเพิ่มเติมที่<strong>การป้องกันข้อมูลของ Microsoft</strong><a href="/fasttrack/products-and-capabilities#security-and-compliance">ใน ความปลอดภัยและ</a>การปฏิบัติตามข้อบังคับ
...
<ul>
<li>  การTeamsนโยบายTeamsแอป (Teamsแอปบนเดสก์ท็อป Teams แอปบนเดสก์ท็อป และ Teams แอป iOS และ Android)  </li>
</ul>
...
<li>  แนวทางสําหรับSkype for Business Teamsการเปลี่ยน  </li>
</ul></td>
<td><ul>
...
<li>  เปิดใช้งานOffice 365กลุ่ม  </li>
  ...
  <strong>หมายเหตุ:</strong> ถ้าไม่มีการมอบหมายและเปิดใช้งานผู้ใช้SharePointสิทธิ์การใช้งาน SharePoint Online พวกเขาจะไม่มีที่OneDrive for Businessเก็บข้อมูลในOffice 365 การแชร์ไฟล์ยังคงสามารถใช้งานในแชนเนลได้ แต่ผู้ใช้ไม่สามารถแชร์ไฟล์ในการแชทOneDrive for Businessเก็บข้อมูลในOffice 365ได้ Teamsไม่สนับสนุนSharePointภายในองค์กร  <br>
  <strong>หมายเหตุ:</strong> สถานะที่เหมาะจะเหมาะที่ผู้ใช้ทุกคนจะเก็บกล่องจดหมายของพวกเขาExchange Onlineกล่องจดหมาย ผู้ใช้ที่มีกล่องจดหมายที่หน้าแรกภายในองค์กรต้องมีข้อมูลเฉพาะตัวของพวกเขาที่ซิงโครไนซ์Office 365ไดเรกทอรีผ่าน Azure AD เชื่อมต่อ For these Exchange hybrid customers, if the user's mailbox is on-premises, the user cannot add or configure Connectors.  
...
<li>  การOutlookความปลอดภัยในอุปกรณ์เคลื่อนที่<a href="/exchange/clients-and-mobile-in-exchange-online/outlook-for-ios-and-android/secure-outlook-for-ios-and-android">(Outlookการรักษาความปลอดภัยบน iOS</a>และ Android Exchange Online ข้อมูลเพิ่มเติม)  </li>
</ul></td>
<td><ul>
<li>  ข้อมูลเฉพาะตัวที่เปิดใช้งานใน Azure AD Office 365ของคุณ  </li>
...
<td>ซอฟต์แวร์ไคลเอ็นต์ออนไลน์ เช่น Power BI Desktopต้องอยู่ในระดับต่สุดตามที่กําหนดไว้ใน ความต้องการของ<a href="https://go.microsoft.com/fwlink/?LinkID=723597">ระบบ</a>Microsoft 365 และ Office</td>
</tr>
<tr class="even">
...
<li>  การติดตั้งProject Onlineเดสก์ท็อปจากOffice 365เดสก์ท็อปของคุณโดยใช้คลิก-ต่อ-รัน  </li>
<li>  การกําหนดค่าการตั้งค่าการอัปเดตOffice 365เครื่องมือการปรับใช้ข้อมูล  </li>
...
<li>  การเชื่อมต่อProject Onlineไคลเอ็นต์เดสก์ท็อปกับProject Online ProfessionalหรือProject Online Premium  </li>
</ul></td>
<td>Online client software like Project for Office 365 must be at a minimum level as defined in the <a href="https://go.microsoft.com/fwlink/?LinkID=723597">System requirements for Microsoft 365 and Office</a>.</td>
</tr>
<tr class="even">
...
<li>  การกําหนดSharePointแบบไฮบริด เช่น การค้นหาแบบไฮบริด ไซต์แบบไฮบริด Taxonomy แบบไฮบริด ชนิดเนื้อหา การสร้างไซต์ด้วยตนเองแบบไฮบริด (SharePoint Server 2013 เท่านั้น) ตัวเปิดใช้แอปแบบขยาย OneDrive for Business แบบไฮบริด และไซต์เอกซ์ทราเน็ต  </li>
...
<li>  การปรับใช้การซิงค์OneDrive for Businessไคลเอ็นต์  </li>
</ul>
  <strong>การโยกย้ายข้อมูล</strong>  <br>
For information on using the FastTrack benefit for data migration to Office 365, see <a href="/fasttrack/data-migration">Data Migration</a>.
</ul></td>
<td><br><strong>สSharePointแบบไฮบริด:</strong>  
<ul>
...
<td>ซอฟต์แวร์ไคลเอ็นต์ออนไลน์ต้องอยู่ในระดับต่่สุดตามที่กําหนดไว้ใน<a href="https://go.microsoft.com/fwlink/?LinkID=723597">ความต้องการของระบบMicrosoft 365 และOffice</a></td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td><strong>Microsoft Intune</strong></td>
<td>  ดูข้อมูลเพิ่มเติมในการรักษาความปลอดภัย<strong>Microsoft Intune</strong><a href="/fasttrack/products-and-capabilities#security-and-compliance">การปฏิบัติตามข้อบังคับ</a>
  </td>
<td>  
...
<li>  การแนะWindows 10ตัวเลือกเพื่อให้คุณสามารถWindows 10แอปได้  </li>
<li>  การเปิดใช้งานการวิเคราะห์เดสก์ท็อปและแนวทางผ่านการสร้างแผนการปรับใช้การวิเคราะห์เดสก์ท็อป  </li>
<li>  Microsoft 365 Appsความเข้ากันได้โดยการใช้ประโยชน์จากแดชบอร์ดความพร้อมของ Office 365 ใน ตัวจัดการการกําหนดค่า หรือด้วย Readiness Toolkit แบบสแตนด์อโลนOffice รวมถึงความช่วยเหลือในการปรับใช้Microsoft 365 Apps  </li>
...
<li>  การให้แนวทางการอัปเกรดเพื่อสนับสนุนการเคลื่อนไหวในการปรับใช้ที่มีอยู่ของคุณ FastTrackแนะนําและให้แนวทางสําหรับการอัปเกรดในสถานที่Windows 10 นอกจากนี้ คู่มือยังพร้อมใช้งานสําหรับWindowsรูปภาพใหม่ทั้งหมด และWindowsสถานการณ์การปรับใช้ Autopilot  </li>
...
<li>  การแปลงระบบ Windows 10จากของ WINDOWS เป็นส่วนติดต่อของเฟิร์มแวร์ Extensible (UEFI) ของ Unified Extensible Firmware Interface (UEFI)  </li>
...
<li>  การใช้ Microsoft Deployment Toolkit (MDT) เพื่อรวบรวมและWindows 10รูปต่างๆ  </li>
...
<td><p>เรามีแนวทางการปรับใช้สําหรับการออนบอร์ดWindowsเดสก์ท็อปเสมือน (บริการการเสมือนของเดสก์ท็อปและแอป) Windows เดสก์ท็อปเสมือนจะใช้ประโยชน์จากประสบการณ์Windows 10แบบหลายเซสชันและถูกปรับให้เหมาะสมกับ Microsoft 365 Apps for Enterprise ที่มีการรักษาความปลอดภัยและการจัดการที่รวมMicrosoft 365การใช้งาน</p>
...
<li>การMicrosoft 365 Appsการกําหนดค่าMicrosoft 365 Apps FSLogix ใน Windowsเดสก์ท็อปเสมือนดั้งเดิม For FSLogix:
<ul>
...
<strong>ต่อไปนี้เป็นการไม่อยู่ในขอบเขต</strong>
<ul>
<li>Projectการปรับใช้โครงสร้างพื้นฐานเดสก์ท็อปเสมือนWindowsของลูกค้า</li>
...
<ul>
<li><a href="/azure/virtual-desktop/overview#requirements">Windowsข้อนะWindowsสิทธิการใช้งาน Virtual Desktop</a></li>
...
<li>Active Directory ที่มีบัญชี Azure AD เชื่อมต่อภายในองค์กรผ่าน VPN หรือ ExpressRoute</li>
...
<li> <strong>Windows 365 Cloud PC</strong> – ดูข้อมูลเพิ่มเติมที่ การแนะนํายุคใหม่ของการประมวลผลส่วนบุคคลแบบไฮบริด: พีซีระบบคลาวด์<a href="https://www.microsoft.com/microsoft-365/blog/2021/07/14/introducing-a-new-era-of-hybrid-personal-computing-the-windows-365-cloud-pc/">Windows 365</a> </li>
</ul>
...
<li>  การค้นคว้าแอป ISV ของบริษัทอื่นWindowsนโยบายความเข้ากันได้และการสนับสนุน ดูข้อมูลเพิ่มเติมที่ <a href="/sccm/desktop-analytics/overview">การวิเคราะห์</a>เดสก์ท็อป</li>
<li>บริการบรรจุภัณฑ์ของแอปเท่านั้น แต่แอปแอป Assure ในทีมแพคเกจที่เราได้แก้ไขWindowsเพื่อให้แน่ใจว่าจะสามารถปรับใช้ในสภาพแวดล้อมของลูกค้าได้</li>
</ul>
...
<ul>
<li>  
  แอปที่Windows 7, Windows 8.1 และ Windows 10ยังWindows 10 Windows 11 อีกด้วย  
  </li>
...
<strong>Windowsบน ARM</strong>
<ul>
<li>  
แอปที่Windows 7, Windows 8.1 และ Windows 10 ยังสามารถWindows 10บนอุปกรณ์ Windows 11 บนอุปกรณ์ ARM64 
  </li>
</ul>
...
<li>  
  แอป 16 บิตไม่ได้รับการสนับสนุนWindows 64 บิต  
  </li>
</ul></td>
</tr>
</tbody>
...
<strong>ต่อไปนี้เป็นการไม่อยู่ในขอบเขต </strong>  
<ul>
<li>Projectการจัดการการปรับใช้งานของลูกค้าMicrosoft Edgeลูกค้า</li>
<li>  การสนับสนุนในสถานที่</li>
