...
<tr class="header">
<th>บริการ</th>
<th>รายละเอียดแนวทาง FastTrack</th>
...
<li>  การปรับใช้Microsoft Endpoint Configuration Managerผลิตภัณฑ์ รวมถึงความช่วยเหลือในการสร้างMicrosoft Endpoint Configuration Managerบรรจุภัณฑ์  
...
<li>  บริการค้นหาที่ตั้งที่เปิดใช้งานตาม<a href="/Office365/Enterprise/office-365-network-mac-perf-overview">ข้อแนะการจัดการ Microsoft 365เครือข่ายในศูนย์เครือข่าย (ตัวอย่าง)</a>  </li>
</ul>
<h3 id="section"></h3></td>
</tr>
</tbody>
...
<li> การความเข้าใจเกี่ยวกับสหสัมพันธ์ของMicrosoft 365 Defenderพอร์ทัลข้อมูล</li>
</ul>
<p><strong>ต่อไปนี้เป็นการไม่อยู่ในขอบเขต</strong></p>
<ul>
<li> Projectการจัดการกิจกรรมการแก้ไขของลูกค้า</li>
...
<li> การกําหนดCloud App Securityให้เป็นไปตามข้อกําหนดการปฏิบัติตามกฎระเบียบหรือข้อบังคับเฉพาะ</li>
...
<li>  การประเมินเวอร์ชันของ OS และการจัดการอุปกรณ์ (รวมถึง Intuned, Microsoft Endpoint Configuration Manager, Group Policy Objects (GPOs) และการกําหนดค่าของบริษัทอื่น) รวมทั้งสถานะของบริการ WINDOWS DEFENDER AV หรือซอฟต์แวร์รักษาความปลอดภัยปลายทางอื่นๆ ของคุณ  </li>
...
<li>  การเปิดใช้งานบริการ Microsoft Defender for Endpoint โดยอธิบายวิธีการปรับใช้โปรไฟล์ตัวแทนของ Defender for Endpoint การตรวจหาและการตอบสนองปลายทาง (EDR) โดยใช้หนึ่งในวิธีการจัดการที่ได้รับการสนับสนุน  </li>
...
<li> Microsoft Defender SmartScreenกําหนดค่าโดยใช้ Microsoft Endpoint Manager</li>
...
<ul>
<li> การออนบอร์ดของอุปกรณ์ที่ไม่มีการจัดการไม่มีขอบเขต FastTrack (เช่น Linux)</li>
...
<td>  เรามีแนวทางระยะไกลเกี่ยวกับการเตรียมพร้อมที่จะใช้ Intun เป็นผู้ให้บริการการจัดการอุปกรณ์เคลื่อนที่ (MDM) บนระบบคลาวด์และการจัดการแอปสําหรับอุปกรณ์เคลื่อนที่ (MAM) สําหรับแอปและอุปกรณ์ของคุณ ขั้นตอนที่แน่นอนจะขึ้นอยู่กับสภาพแวดล้อมต้นทางของคุณ และยึดตามความต้องการด้านการจัดการอุปกรณ์เคลื่อนที่และแอปบนอุปกรณ์เคลื่อนที่ของคุณ ขั้นตอนต่างๆ รวมถึง:
<ul>
...
<li>  การกําหนดค่าไคลเอ็นต์Outlookกล่องจดหมาย (Outlook Windowsจดหมาย Outlook บนเว็บ Outlookไคลเอ็นต์กล่องจดหมาย (for iOS และ Android)  </li>
</ul>
...
<tr class="odd">
<td><strong>Azure Information Protection </strong></td>
<td>  ดูข้อมูลเพิ่มเติมเกี่ยวกับ Azure Information Protection ที่<strong>การป้องกันข้อมูลของ Microsoft</strong><a href="/fasttrack/products-and-capabilities#security-and-compliance">การรักษาความปลอดภัยและ</a>การปฏิบัติตามข้อบังคับ  </td>
<td>  
...
<li>  การประเมินสภาพแวดล้อมต้นทางและความต้องการของคุณ (ตรวจสอบให้แน่ใจว่าMicrosoft Endpoint Configuration Managerได้อัปเกรดเป็นระดับที่ต้องใช้เพื่อสนับสนุนWindows 10การใช้งาน)  </li>
...
<ul>
<li>การปรับใช้Windows 10 Enterpriseหลายเซสชัน และMicrosoft 365 Apps for Enterprise โดยใช้รายการต่อไปนี้:
<ul>
<li>รูป Azure Marketplace</li>
<li>รูปภาพที่แชร์</li>
<li>Office Deployment Toolkit (ODT)</li>
</ul></li>
<li>การMicrosoft 365 Appsการกําหนดค่าWindows FSLogix Windowsบนเดสก์ท็อปเสมือน For FSLogix:
<ul>
...
<ul>
<li><a href="/azure/virtual-desktop/store-fslogix-profile">ที่เก็บข้อมูลของคอนเทนเนอร์โปรไฟล์ FSLogix Windowsด้านบน Virtual Deskstop</a> </li>
</ul>
...
<ul>
<li>  
  แอปที่Windows 7, Windows 8.1 และ Windows 10ยังWindows 10 Windowsได้ในวันที่ 11  
  </li>
...
<ul>
<li> แอปที่Windows 7, Windows 8.1 และ Windows 10ยังสามารถWindowsบน Cloud PC 365</li>
</ul>
<strong>Windowsวันที่ ARM</strong>
<ul>
<li>  
แอปที่Windows 7, Windows 8.1 และ Windows 10 ยังสามารถWindows 10 Windows 11 บนอุปกรณ์ ARM64 
  </li>
</ul>
...
<li>  
  Windows 10 EnterpriseและWindowsแบบหลายเซสชันขององค์กร 11 รายการ
  </li>
</ul>
</ul>
...
<li> การวางแผนแนวทางสําหรับการนํา Microsoft Edge มาใช้และการกําหนดค่าMicrosoft Searchบุ๊กมาร์กของคุณ</li>
</ul>
