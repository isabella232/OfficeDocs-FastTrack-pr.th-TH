...
\*\*\*สามารถใช้สำหรับทั้ง Skype สำหรับธุรกิจออนไลน์และผู้ใช้ Microsoft ทีมงานที่ได้รับอนุญาต
...
|**การป้องกันข้อมูลของ Microsoft Azure**    |  พร้อมใช้งานสำหรับ P2 เป็นส่วนหนึ่งของ E5 หรือแผนแบบสแตนด์อโลน มิฉะนั้น นี้ถูกส่ง ถึงผู้เชี่ยวชาญ ด้านแบบ FastTrack หรือ สำหรับการอ้างอิงบริษัทในเครือ        |
