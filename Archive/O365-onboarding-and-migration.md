...
description: Office 365การออนบอร์ดมีสี่ขั้นตอนหลัก คือ เริ่มต้น ประเมิน แก้ไข และเปิดใช้งาน คุณสามารถปฏิบัติตามขั้นตอนเหล่านี้ด้วยขั้นการโยกย้ายข้อมูลเพิ่มเติม
ms.openlocfilehash: a28ef15e72ddc7d16f1f3ccd1b2ec8ccac539ea7
ms.sourcegitcommit: f69357b9e3b2edf60c1b9b22f106ac0b1b345d02
ms.translationtype: MT
ms.contentlocale: th-TH
ms.lasthandoff: 08/23/2021
ms.locfileid: "58468485"
---
...
Office 365การออนบอร์ดมีสี่ขั้นตอนหลัก คือ เริ่มต้น ประเมิน แก้ไข และเปิดใช้งาน คุณสามารถปฏิบัติตามขั้นตอนเหล่านี้ด้วยขั้นการโยกย้ายข้อมูลเพิ่มเติมตามที่แสดงในรูปต่อไปนี้
  
![ขั้นตอนต่างๆ ของสิทธิประโยชน์ Onboarding](media/O365-Onboarding-Phases.png)
  
> [!NOTE]
>For information onboarding and migration for Office 365 GOVERNMENT US, see [Onboarding and Migration for Office 365 US Government](US-Gov-appendix-onboarding-and-migration.md). 
...
โดยยึดตามการตั้งค่าปัจจุบันของคุณ เรามีแผนในการแก้ไขที่เพิ่มสภาพแวดล้อมต้นทางของคุณไปยังความต้องการขั้นต่เพื่อให้การออนบอร์ดOffice 365ประสบความสาเร็จ และเพื่อกล่องจดหมายและ/หรือการโยกย้ายข้อมูลสาเร็จ ถ้าเป็น เรามีชุดกิจกรรมที่แนะนําเพื่อเพิ่มค่าผู้ใช้และการนํามาใช้ นอกจากนี้ เรายังตั้งค่าการโทรไปยังจุดตรวจสอบที่เหมาะสมเพื่อไปยังขั้นตอนการแก้ไขอีกด้วย
...
ในระหว่างขั้นตอนนี้ ผู้จัดการ FastTrack ของคุณจะพร้อมให้ความช่วยเหลือคุณเกี่ยวกับการวางแผนความสเร็จ และให้แนวทางแก่คุณสู่แหล่งข้อมูลที่เหมาะสม และแนวทางปฏิบัติที่ดีที่สุดเพื่อเป็นแนวทางสําหรับคุณในการจัดเตรียมบริการให้พร้อมใช้งานสําหรับองค์กรของคุณ และผลักดันการใช้งานบริการต่างๆ
...
การออนบอร์ดหลักเกี่ยวข้องกับการเตรียมใช้งานบริการและการผสานรวมผู้เช่าและข้อมูลเฉพาะตัว นอกจากนี้ยังมีขั้นตอนในการมอบพื้นฐานบริการการออนบอร์ด เช่น Exchange Online SharePoint Online Skype for Business Online คุณและผู้จัดการFastTrackของคุณยังมีการวางแผนการประชุมแบบ CheckPoint ที่สเร็จต่อไปเพื่อประเมินความคืบหน้าตามเป้าหมายของคุณ และพิจารณาเกี่ยวกับความช่วยเหลือเพิ่มเติมที่คุณต้องการ
...
- การตั้งค่าฟีเจอร์Office 365 Advanced Threat Protection (ATP) หากเป็นส่วนหนึ่งของบริการการสมัครใช้งานของคุณ หากต้องการข้อมูลเพิ่มเติม โปรดดู[Office 365 Advanced Threat Protection](#office-365-advanced-threat-protection)
...
> [!NOTE]
> บริการการเก็บถาวรกล่องจดหมาย (MRS) พยายามโยกย้ายอีเมลที่จัดการสิทธิ์ในข้อมูล (IRM) จากกล่องจดหมายภายในองค์กรของคุณไปยังกล่องจดหมายExchange Onlineกล่องจดหมายของคุณ ความสามารถในการอ่านเนื้อหาที่มีการป้องกันหลังการโยกย้ายจะขึ้นอยู่กับการแมปลูกค้าและการคัดลอกเทมเพลต Active Directory Rights Managed Services (AD RMS) ไปยัง Azure Rights Management Service (Azure RMS)
...
- การกําหนดค่าไคลเอ็นต์กล่องจดหมาย (Outlookไคลเอ็นต์Windows Outlook บนเว็บกล่องจดหมาย Outlookไคลเอ็นต์กล่องจดหมาย (for iOS และ Android)
    > [!NOTE]
...
- การกําหนดSharePointแบบไฮบริด เช่น การค้นหาแบบไฮบริด ไซต์แบบไฮบริด Taxonomy ไฮบริด ชนิดเนื้อหา การสร้างไซต์ด้วยตนเองแบบไฮบริด (SharePoint Server 2013 เท่านั้น) ตัวเปิดใช้แอปแบบขยาย ไฮบริด OneDrive for Business และไซต์เอ็กซ์ทราเน็ต
    
FastTrack ผู้เชี่ยวชาญด้านให้แนวทางในการโยกย้ายOffice 365ข้อมูลโดยใช้เครื่องมือและเอกสารร่วมกัน และโดยการกําหนดค่างานที่เหมาะสมและเป็นไปได้
...
สําหรับการป้องกันข้อมูลของ Microsoftเราจะให้แนวทางสําหรับ:
...
- การกําหนดค่าพอร์ตไฟร์วอลล์   
- การตั้งค่า DNS 
- การยืนยันMicrosoft Teamsถูกเปิดใช้งานบนผู้Office 365ของคุณ  
...
![ขั้นตอนที่เกิดขึ้นระหว่างขั้นตอนการเปิดใช้งานProject Onlineขั้นตอน](media/d8dd7d31-1df6-4df4-a1aa-4dbdd34b973e.png)
...
- การติดตั้งProject Onlineเดสก์ท็อปจากOffice 365เดสก์ท็อปของคุณโดยใช้คลิก-ต่อ-รัน
...
![ขั้นตอนที่เกิดขึ้นระหว่างขั้นตอนการเปิดใช้งานของProject for Office 365](media/f0133291-7c12-4db0-af61-75ec5e71451c.png)
  
## <a name="yammer-enterprise"></a>Yammer Enterprise

สําหรับYammerนี้ เรามีแนวทางสําหรับการเปิดใช้งานYammer Enterpriseบริการของคุณ
  
## <a name="microsoft-365-apps"></a>Microsoft 365 Apps

สําหรับMicrosoft 365 Appsเราจะให้แนวทางสําหรับ:
- การแก้ไขปัญหาการปรับใช้   
- การกําหนดสิทธิ์การใช้งานของผู้ใช้ปลายทางและตามอุปกรณ์[โดยใช้ศูนย์การจัดการ Microsoft 365และ](https://go.microsoft.com/fwlink/?linkid=2032704)Windows PowerShell 
